...
const clients = [
  ...
  {
    name: "Orange",
    logo: "/asset/Orange_logo.svg.png",
    width: 120,
    height: 60,
  },
  {
    name: "Maroc Telecom",
    logo: "/asset/maroctelecom.png",
    width: 150,
    height: 60,
  },
  {
  ...
  {
    name: "Finetech",
    logo: "/asset/finatech.jpg",
    width: 120,
    height: 60,
  },
  {
    name: "Infra",
    logo: "/asset/linfra.png",
    width: 120,
    height: 60,
  },
  {
  ...
  {
    name: "Camusat",
    logo: "/asset/Camusat.jpg",
    width: 120,
    height: 60,
  },
  {
    name: "Telcam",
    logo: "/asset/telcam.png",
    width: 120,
    height: 60,
  },
  {
                ...
                >
                  <div className="relative w-full h-full">
                    <img
                      ...
                      alt={client.name}
                      className="w-full h-full object-contain filter blue  transition-all"
                    />
                  </div>
                </div>
              ))}
